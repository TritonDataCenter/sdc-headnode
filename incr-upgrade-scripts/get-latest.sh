...
ROLES="adminui amon amonredis assets ca cloudapi cnapi dapi dhcpd fwapi imgapi napi papi rabbitmq redis sapi sdc sdcsso ufds vmapi workflow moray manatee"
