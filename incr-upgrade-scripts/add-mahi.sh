...
#
#   ./add-mahi.sh d7a36bca-4fdd-466f-9086-a2a22447c257 mahi-zfs-master-20130711T073353Z-g7dcddeb
#
...
if [[ ! -n $NEW_IMAGE ]]; then
  ...
  ary=($(updates-imgadm list name=manta-authcache -o uuid,name,version | tail -1))
  NEW_IMAGE=${ary[0]}
...
IS_IMAGE_IMPORTED=$(sdc-imgadm list -o uuid name=manta-authcache | grep $NEW_IMAGE || true)
