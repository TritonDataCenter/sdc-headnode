...
# if [ ! -e /opt/smartdc/cloudapi/deps/request/index.js ]; then
#     (cd /opt/smartdc/cloudapi/deps/request; ln -s main.js index.js)
# fi
# 
# # Update the config with the correct values.
# cat > /opt/smartdc/cloudapi/config.js <<HERE
# exports.config = {
...
# 
#         location / {
#             root /opt/smartdc/cloudapi/public;
